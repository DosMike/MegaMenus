...
public interface IMenu extends Identifiable {
     ...
     * if as a result the page is empty it will not be remove.
     ...
     * this allows clearing all pages with <pre>while (pages()&gt;1) removePage(1);</pre>
     * @param page the page to remove
     */
    void removePage(int page);
    /**
     * unbind and remove all elements from this page. this will keep empty pages
     * in the menu.
     * @param page the page to remove
     */
