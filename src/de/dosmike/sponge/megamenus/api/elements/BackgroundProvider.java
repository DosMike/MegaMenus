...
public interface BackgroundProvider {
    ...
    IIcon GRAY_PANE_IICON = IIcon.of(ItemStack.builder().itemType(ItemTypes.STAINED_GLASS_PANE).add(Keys.DYE_COLOR, DyeColors.SILVER).add(Keys.DISPLAY_NAME, Text.EMPTY).build());
